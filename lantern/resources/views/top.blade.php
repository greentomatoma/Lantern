...
<div id="main" class="top-container">
  ...
  <div class="t-main-content">
    ...
    <div class="t-main-about">
      <h2 class="about-title"><span class="t-main-about-text">Lantern</span>でできること</h2>
      <div class="t-items">
        <div class="t-item">
          <p class="t-item-title"><span class="number">01</span>閲覧</p>
          <img src="/images/top_page/top_look.png">
          <p class="t-item-text">みんなのアイデアがいつでも見れる</p>
        </div>
        <div class="t-item">
        <p class="t-item-title"><span class="number">02</span>投稿</p>
          <img class="top-share" src="/images/top_page/top_share.png">
          <p class="t-item-text">アイデアを投稿しみんなで共有</p>
        </div>
        <div class="t-item">
        <p class="t-item-title"><span class="number">03</span>保存</p>
